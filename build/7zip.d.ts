/// <reference path="../../TS-ByteArray/src/ctypes/ctypes.d.ts" />
/// <reference path="../src/nid/7zip/7zip.d.ts" />
/**
* JavaScript Uint64
* version : 0.1
...
declare module nid {
    class SevenZip {
        ...
        private startHeaderCRC;
        private nextHeaderOffset;
        private nextHeaderSize;
        private nextHeaderCRC;
        private data;
